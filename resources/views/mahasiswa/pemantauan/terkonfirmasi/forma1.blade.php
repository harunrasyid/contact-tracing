...
<div class="main">
    <div class="main-content">
        <div class="container-fluid">
            <form action="/mahasiswa/postforma1" method="POST" novalidate enctype="multipart/form-data">
            {{csrf_field()}}
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <!-- NIM -->
                                <div class="form-group">
                                    <label class="form-label">Nomor Induk Mahasiswa/Nomor Induk Pegawai/Nomor ID Tenant</label>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group{{$errors->has('gejala') ? 'has-error' : ' ' }}" style="margin-bottom: 20px;">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <label class="form-label">Apakah anda/kasus terkonfirmasi mengalami gejala kesehatan dalam 1 minggu terakhir? <b style="color:red;">*</b></label>
                                        </div>
                                        <div class="col-xs-2">
                                ...
                                <div class="form-group{{$errors->has('tgl_gejala_pertama') ? 'has-error' : ' ' }}" style="margin-bottom: 30px;">
                                    <label style="margin-bottom: 10px;">Tanggal Gejala Pertama Kali Muncul (Jika Mengalami Gejala Kesehatan)</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="">Pre-exsisting Condition Pada Kasus Terkonfirmasi</h3>
                            </div>
                            <div class="panel-body">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="sumber_infeksi" id="sumber_infeksi">
                                        <option value="">Sumber Infeksi Diketahui?</option>
