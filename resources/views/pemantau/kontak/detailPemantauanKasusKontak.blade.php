                        ...
                        @if( date('Y-m-d',strtotime($date))  ==  date('Y-m-d',strtotime($tanggal_mulai)) )
                            <div class="col-xs-12 col-sm-6 col-md-3 text-left" style="border-style: ridge; background-color:#DFF2FF;">
                                ...
                                <div style="min-height: 5em;">
                                    @if($i == 1)
                                        <h5><a href="/pemantau/{{ date('Y-m-d',strtotime($tanggal_mulai)) }}/{{$kasus_kontak->id}}/formb1">Pemantauan Awal Kasus Kontak (Form B1)</a></h5>
                                    @elseif($i == 15)
                                        <h5><a href="/pemantau/{{ date('Y-m-d',strtotime($tanggal_mulai)) }}/{{$kasus_kontak->id}}/formb2">Pemantauan Akhir Kasus Kontak (Form B2)</a></h5>
                                    @else
                                        <h5><a href="/pemantau/{{ date('Y-m-d',strtotime($tanggal_mulai)) }}/{{$kasus_kontak->id}}/formb3">Pemantauan Rutin Kasus Kontak</a></h5>
                                    @endif
                                </div>
                            </div>
