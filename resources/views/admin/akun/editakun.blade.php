        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    @endif
                    <div class="col-md-12">
                        <form action="/admin/{{$user->id}}/updateAkun" method="POST">
                        {{csrf_field()}}
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3>Ubah Alamat Email Akun Admin</h3>
                                </div>
                                <div class="panel-body">

                                    <div class="form-group{{$errors->has('email') ? 'has-error' : ' ' }}">
										<label class="form-label">Email Akun Admin</label>
                                    ...
                                    <h3 style="margin-top: 50px; margin-bottom: 30px;">Ubah Password Akun Admin</h3>
